(function (d3) {
    ...
    function vizJoinData(countryArrayFromData, countryData, countryNameArrayFromMap){
    ...
    function drawDetail(givenSection, givenData) {
    ...
    function vizDrawMap(givenG, givenSection, pathCreator, countryData, colorScale) {
    ...
    function vizDrawLegend(givenG, uniqCategories, colorScale) {
        let size = 20;
